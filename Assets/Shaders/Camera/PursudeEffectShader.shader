// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'
 ...
 Shader "Custom/PursudeEffectShader" {
      Properties {
          _Color ("Color", Color) = (1,0,0,0)
          _Thickness("Thickness", Range(0.0,0.5)) = 0.05
          _Radius("Radius", Range(0.0, 2.0)) = 0.4
          _Dropoff("Dropoff", Range(0.01, 5)) = 0.1
      ...
      SubShader {
          ...
          Pass {
              ...
              fixed4 frag(fragmentInput i) : SV_Target {
				 ...
				 fixed4 col = fixed4(_Color.r, _Color.g, _Color.b, _Color.a*antialias(_r, distance, _Thickness, _Dropoff));
				 col.a -= col.a/2.0;
                 return col;
              }
